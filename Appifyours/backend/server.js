...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/tea_shop_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '6915ed0fa4f75e1059c4c58e',
      shopName: 'Tea shop',
...
app.listen(PORT, () => {
  console.log(`Tea shop Backend Server running on port ${PORT}`);
});
